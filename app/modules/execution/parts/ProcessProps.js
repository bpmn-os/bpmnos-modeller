...
module.exports = function(group, element, bpmnFactory, translate) {
  ...
  function getSelectedAttribute(element, node) {
    ...
    return helper.getObject(element, selected.idx, 'execution:Attributes');
  }
...
//      element = element.labelTarget || element;
  ...
  var attributesEntry = extensionElements(element, bpmnFactory, {
    ...
    createExtensionElement: function(element, extensionElement, value) {
      ...
      var containerElement = helper.getContainerElement(element,'execution:Attributes');
      if (!containerElement) {
        containerElement = elementHelper.createElement('execution:Attributes', {}, extensionElement, bpmnFactory);
      ...
      var attribute = elementHelper.createElement('execution:Attribute', { key: value }, containerElement, bpmnFactory);
    ...
    getExtensionElements: function(element) {
      return helper.getObjectList(element,'execution:Attributes');
    },
  ...
  group.entries.push(entryFactory.validationAwareTextField({
    ...
    validate: function(element, values, node) {
      ...
      if (attribute) {
        ...
        var attributes = helper.getObjectList(element,'execution:Attributes')
